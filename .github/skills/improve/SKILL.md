---
name: improve
description: "Enhance existing features through story-driven development with full verification. Use when asked to improve, enhance, or extend existing functionality."
---
