---
name: evaluate
description: Run the application and verify sprint contract criteria via API tests, Playwright interaction, and schema validation. Use when asked to evaluate, verify, or check if features pass.
allowed-tools: shell
---
...
In Full mode, delegate to the design-critic custom agent:
