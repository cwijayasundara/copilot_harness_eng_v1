---
name: deploy
description: Generate Docker Compose stack, Dockerfiles, environment config, and init.sh bootstrap script. Use when asked to containerize, deploy, or create deployment config.
allowed-tools: shell
---
