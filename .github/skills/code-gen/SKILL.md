---
name: code-gen
description: "Code generation quality principles — TDD, typing, error handling, logging, API integration, LLM integration. Use when writing code, implementing features, or reviewing code quality."
---
