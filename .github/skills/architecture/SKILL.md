---
name: architecture
description: "Layered architecture rules — one-way imports, module boundaries, file organization. Use when checking architecture compliance, reviewing layer violations, or enforcing dependency rules."
---
