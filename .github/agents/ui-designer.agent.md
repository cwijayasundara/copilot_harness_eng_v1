...
**Scope fidelity:** Mockups must reflect the scope of the story, not invented features. If the story says "list view," the *information architecture* stays a list — but the *visual execution* should be distinctive and committed to the aesthetic direction. Bold aesthetic does not equal scope creep. Do not invent filtering, sorting, or data that is not in the story's acceptance criteria.
