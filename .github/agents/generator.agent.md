...
For each sprint group, invoke custom agents to work in parallel:
...
**Agent team dependency:** If teams are unavailable, fall back to sequential story implementation but maintain the same hand-off discipline.
