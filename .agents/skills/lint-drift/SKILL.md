---
name: lint-drift
description: "Scan codebase for pattern drift and generate targeted cleanup PRs. Entropy control for agent-generated code. Use when asked to check consistency, scan for drift, or enforce patterns."
---
