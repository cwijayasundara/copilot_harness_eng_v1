---
name: brd
description: "Socratic interview to create a Business Requirements Document. Use when starting a new project, gathering requirements, or asked to create a BRD."
agent: planner
---
